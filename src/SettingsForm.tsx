...
import { computeAtPodium, computeSuitcaseAvailable } from "./settingsRules";
...
export function SettingsForm({
  ...
  const suitcaseAvailable = computeSuitcaseAvailable(atPodium, narrationOn, narrationDisabled);
